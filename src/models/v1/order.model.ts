...
export const ORDER_ON_THE_LINE_STATUS = 'ONHOLD';
export const ORDER_ONGOING_STATUS = 'ONGOING';
export const ORDER_COMPLETE_STATUS = 'COMPLETE';
export const ORDER_STATUS = [
  'WAITING_PAYMENT',
  'FAILED',
  'PENDING',
  ORDER_ON_THE_LINE_STATUS,
  ORDER_ONGOING_STATUS,
  ORDER_READY_STATUS,
  ORDER_COMPLETE_STATUS,
];

export const ORDER_BALCONY_STATUS = [
  ORDER_ON_THE_LINE_STATUS,
  ORDER_ONGOING_STATUS,
  ORDER_READY_STATUS,
  ORDER_COMPLETE_STATUS,
];
export const ORDER_STAFF_UPDATE_STATUS = [
  ORDER_ON_THE_LINE_STATUS,
  ORDER_ONGOING_STATUS,
  ORDER_READY_STATUS,
];
