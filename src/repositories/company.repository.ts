...
import {BelongsToAccessor,HasManyRepositoryFactory,HasOneRepositoryFactory,ReferencesManyAccessor,repository} from '@loopback/repository';
import {SoftCrudRepository} from 'loopback4-soft-delete';
import {PostgresSqlDataSource} from '../datasources';
import {Company,CompanyRelations,Contacts,Event,Image,Place,Staff,Team} from '../models';
...
> {
  ...
  public readonly teams: HasManyRepositoryFactory<Team, typeof Company.prototype.id>;

  public readonly events: HasManyRepositoryFactory<Event, typeof Company.prototype.id>;

  public readonly previousPlaces: ReferencesManyAccessor<Place, typeof Company.prototype.id>;
  ...
  constructor(
    ...
    this.previousPlaces = this.createReferencesManyAccessorFor('previousPlaces', placeRepositoryGetter,);
    this.registerInclusionResolver('previousPlaces', this.previousPlaces.inclusionResolver);
