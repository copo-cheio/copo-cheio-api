...
> {
  ...
  public readonly teamStaffs: HasManyRepositoryFactory<
    TeamStaff,
    typeof Team.prototype.id
  >;

  public readonly cover: BelongsToAccessor<
    Image,
  ...
  constructor(
    ...
    this.teamStaffs = this.createHasManyRepositoryFactoryFor(
      'teamStaffs',
      teamStaffRepositoryGetter,
    );
    this.registerInclusionResolver(
      'teamStaffs',
      this.teamStaffs.inclusionResolver,
    );
